...
export default function LoginForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6 w-full p-8 bg-white/[0.02] border border-white/10 rounded-[2.5rem] backdrop-blur-xl shadow-3d shadow-black/40 animate-in fade-in zoom-in-95 duration-500">
      ...
      <Button
        ...
        loading={loading}
        className="mt-3 w-full rounded-full border-none bg-blue-600 py-4 text-lg font-bold text-white shadow-[0_20px_45px_-18px_rgba(37,99,235,0.9)] transition-all hover:scale-[1.01] hover:bg-blue-50 hover:shadow-[0_28px_56px_-18px_rgba(37,99,235,0.95)] active:scale-[0.99]"
      />
    </form>
  );
}
